...
function buildExport(rows, counts, now = new Date()) {
  ...
  const lines = [
    ...
    '# NEURO Tasks — export',
    '',
    `> **Generated file. Do not edit.** NEURO owns tasks now; this is a read-only copy so`,
    '> they stay readable in Obsidian and on the phone when the Pi is unreachable.',
    '>',
    `> **Last exported: ${human}** — if that looks stale, NEURO is down and this list is`,
    '> behind. Edits made here are overwritten on the next export.',
    '>',
